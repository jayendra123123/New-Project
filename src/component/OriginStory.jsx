...
environment.
            ...
            <div className="flex gap-3 mt-4">
              <a href="https://github.com/jayendra123123" target="_blank" rel="noopener noreferrer" className="p-2 bg-white dark:bg-[#332f1d] rounded-full border-2 border-dark-text dark:border-white/20 shadow-comic-sm hover:shadow-comic hover:-translate-y-1 transition-all text-dark-text dark:text-white">
              ...
              <a href="#" target="_blank" rel="noopener noreferrer" className="p-2 bg-white dark:bg-[#332f1d] rounded-full border-2 border-dark-text dark:border-white/20 shadow-comic-sm hover:shadow-comic hover:-translate-y-1 transition-all text-[#0077b5]">
              ...
              <a href="#" target="_blank" rel="noopener noreferrer" className="p-2 bg-white dark:bg-[#332f1d] rounded-full border-2 border-dark-text dark:border-white/20 shadow-comic-sm hover:shadow-comic hover:-translate-y-1 transition-all text-[#FFA116]">
          ...
          <div className="flex-1 w-full grid grid-cols-1 gap-6">
            {panels.map((panel, idx) => (
              <div 
                key={idx}
                id={panel.id}
                className={`bg-white dark:bg-[#332f1d] p-6 rounded-lg border-2 border-dark-text dark:border-white/20 shadow-comic flex items-start gap-4 hover:scale-[1.02] transition-transform ${panel.offset || ''}`}
              >
