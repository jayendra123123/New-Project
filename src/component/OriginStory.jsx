...
environment.
            ...
            <div className="flex gap-3 mt-4">
              ...
              <button type="button" className="p-2 bg-white dark:bg-[#332f1d] rounded-full border-2 border-dark-text dark:border-white/20 shadow-comic-sm hover:shadow-comic hover:-translate-y-1 transition-all text-[#0077b5]">
              ...
              <button type="button" className="p-2 bg-white dark:bg-[#332f1d] rounded-full border-2 border-dark-text dark:border-white/20 shadow-comic-sm hover:shadow-comic hover:-translate-y-1 transition-all text-[#FFA116]">
